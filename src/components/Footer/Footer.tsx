        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="group">
            <div className="flex items-center mb-4 group-hover:scale-105 transition-transform duration-200">
              <div className="w-10 h-10 bg-black/60 rounded-lg flex items-center justify-center group-hover:bg-black/80 transition-colors duration-200 backdrop-blur-sm border border-white/25">
                <span className="text-white font-bold text-xl group-hover:text-white/90 transition-colors duration-200">
                  {studio.name.charAt(0)}
                </span>
              </div>
              <div className="ml-3">
                <span className="text-xl font-bold group-hover:text-white/90 transition-colors duration-200">
                  {studio.name}
                </span>
                <div className="text-xs text-white/70 group-hover:text-white/80 transition-colors duration-200">
                  {studio.tagline}
                </div>
              </div>
            </div>
            <p className="text-white/80 group-hover:text-white/70 transition-colors duration-200">
              {studio.description.substring(0, 100)}...
            </p>
          </div>

          <div className="group">
            <h4 className="font-semibold mb-4 group-hover:text-white/90 transition-colors duration-200">
              {sections.footer.servicesTitle}
            </h4>
          ...
          <div className="group">
            ...
            <ul className="space-y-2 text-white/80">
              ...
              <li className="hover:text-white/70 transition-colors duration-200">
